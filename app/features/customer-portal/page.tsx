...
export const metadata: Metadata = {
  ...
  description:
    'Give your B2B customers self-service access to real-time inventory, custom pricing, order history, and account management.',
  keywords: [
    'B2B portal',
    'customer portal',
    'self-service',
...
const benefits = [
  {
    ...
    description:
      'Customers can check real-time inventory, view their pricing, and place orders 24/7.',
    icon: 'users',
  },
  {
    title: 'Account Management',
    description:
      'View invoices, track shipments, manage users, and download statements.',
    icon: 'shield-check',
  },
  {
    title: 'Custom Pricing Display',
    description:
      'Each customer sees their negotiated prices, volume discounts, and available credit.',
    icon: 'trending-up',
  },
  {
    title: 'Quick Reorder',
    description:
      'One-click reordering from order history with smart suggestions.',
    icon: 'refresh',
  },
  {
    title: 'Mobile Responsive',
    description:
      'Full functionality on any device for sales reps and customers on the go.',
    icon: 'zap',
  },
  {
    title: 'White Label Options',
    description:
      'Customize branding, colors, and domain to match your company identity.',
    icon: 'lock',
  },
]
