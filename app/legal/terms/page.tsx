...
export const metadata: Metadata = {
  ...
  description:
    'Read the TruthSource terms of service. Learn about your rights and responsibilities when using our B2B data synchronization platform.',
}
    ...
    <PageWrapper>
      ...
      >
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p>
            By accessing and using TruthSource ("Service"), you accept and agree
          ...
          <p>
            TruthSource provides a B2B data synchronization platform that
            enables businesses to sync inventory, pricing, and customer data
            across multiple e-commerce and ERP systems. The Service includes:
          </p>
          <ul>
          ...
          <p>
            You must be 18 years or older to use this Service. You must provide
          ...
          <p>
            A valid payment method is required for paid accounts. You will be
            billed in advance on a recurring and periodic basis (monthly or
            annual). You can cancel your subscription at any time.
          </p>

          <h2 id="data-privacy">5. Data Privacy and Security</h2>
          <p>
            We take data privacy seriously. Your business data is encrypted at
            rest and in transit. We maintain SOC 2 compliance and follow
            industry best practices for data security. See our Privacy Policy
            for more details.
          </p>
          ...
          <p>
            API usage is subject to rate limits as specified in your plan.
            Excessive API usage may result in temporary throttling or account
            suspension.
          </p>
          ...
          <p>
            In no event shall TruthSource, nor its directors, employees,
