...
export const metadata: Metadata = {
  ...
  description:
    'Learn about how TruthSource uses cookies and similar tracking technologies to improve your experience.',
}
    ...
    <PageWrapper>
      ...
      >
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p>
            TruthSource uses cookies and similar tracking technologies for the
            following purposes:
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Analytics cookies:</strong> Provide insights to improve
              our services
            </li>
          </ul>
          ...
          <p>
            ...
            pages. We do not control these cookies. Third-party providers
            include:
          </p>
          <ul>
