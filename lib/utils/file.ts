 ...
 *
 * In environments where the global `File` constructor is unavailable (such as Node.js), this function checks for the presence of typical File properties (`name`, `size`, and `stream`).
 *
