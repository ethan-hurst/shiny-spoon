...
export function NotificationSettings({
  ...
  const [settings, setSettings] = useState({
    ...
    billingAlerts:
      preferences.billing_alerts ??
      DEFAULT_NOTIFICATION_PREFERENCES.billingAlerts,
    usageAlerts:
      preferences.usage_alerts ?? DEFAULT_NOTIFICATION_PREFERENCES.usageAlerts,
    teamUpdates:
      preferences.team_updates ?? DEFAULT_NOTIFICATION_PREFERENCES.teamUpdates,
    apiUpdates:
      preferences.api_updates ?? DEFAULT_NOTIFICATION_PREFERENCES.apiUpdates,
    productUpdates:
      ...
      settings: [
        {
          ...
          description:
            NOTIFICATION_CATEGORIES.BILLING.settings.billingAlerts.description,
          icon: CreditCard,
        },
      ],
    },
      ...
      settings: [
        {
          ...
          description:
            NOTIFICATION_CATEGORIES.USAGE.settings.usageAlerts.description,
          icon: BarChart3,
        },
      ],
    },
      ...
      settings: [
        {
          ...
          description:
            NOTIFICATION_CATEGORIES.TEAM.settings.teamUpdates.description,
          icon: Users,
        },
      ],
    },
      ...
      settings: [
        {
          ...
          description:
            NOTIFICATION_CATEGORIES.API.settings.apiUpdates.description,
          icon: Key,
        },
      ],
    },
      ...
      settings: [
        {
          ...
          description:
            NOTIFICATION_CATEGORIES.PRODUCT.settings.productUpdates.description,
          icon: Package,
        },
      ],
    },
      ...
      settings: [
        {
          ...
          description:
            NOTIFICATION_CATEGORIES.SECURITY.settings.securityAlerts
              .description,
          icon: Shield,
        },
      ],
