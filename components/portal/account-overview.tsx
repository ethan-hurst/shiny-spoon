...
export function AccountOverview({ organization, subscription }: AccountOverviewProps) {
      ...
      <CardContent className="space-y-6">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Organization ID</h3>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{format(new Date(organization.created_at), 'MMM d, yyyy')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">{getPlanDisplayName(subscription?.plan || 'free')}</span>
            ...
            {subscription && subscription.id !== 'free' && (
              <div>
                <h3 className="text-sm font-medium text-muted-foreground mb-2">Billing Period</h3>
                <div className="flex items-center gap-2">
                ...
                {subscription.cancelAtPeriodEnd && (
                  <p className="text-sm text-destructive mt-1">
                    Subscription will cancel on {format(subscription.currentPeriodEnd, 'MMM d, yyyy')}
                  </p>
                )}
              </div>
            )}
