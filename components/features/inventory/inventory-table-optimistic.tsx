...
export const InventoryTableOptimistic = React.memo(
  function InventoryTableOptimistic({
    initialData,
    organizationId,
          ...
          cell: ({ row }) => {
            ...
            return (
              <div className="flex items-center gap-2">
                <div
                  className={cn('font-medium', outOfStock && 'text-red-600')}
                >
    ...
    const handleAdjustmentSuccess = React.useCallback(
              ...
              {virtualRows.map((virtualRow) => {
                ...
                return (
                  <TableRow
                    ...
                    className={cn(
                      getItemStatus(row.original.id) === 'pending' &&
                        'opacity-70'
                    )}
                  >
