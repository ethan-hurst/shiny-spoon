...
export function SyncScheduleDialog({
  ...
  const onSubmit = async (values: FormData) => {
    ...
    try {
      ...
      if (
        values.active_hours_enabled &&
        values.active_hours_start &&
        values.active_hours_end
      ) {
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="every_5_min">
                          Every 5 minutes
                        </SelectItem>
                        <SelectItem value="every_15_min">
                          Every 15 minutes
                        </SelectItem>
                        <SelectItem value="every_30_min">
                          Every 30 minutes
                        </SelectItem>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              be undone and the integration will stop syncing automatically.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
