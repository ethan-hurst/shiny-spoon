...
import { AlertTriangle, Clock, Database, Globe } from 'lucide-react'
...
export function ConflictResolutionDialog({
  ...
  const [resolutions, setResolutions] = useState<
    Record<string, 'source' | 'target' | 'merge'>
  >({})
      ...
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {conflicts.length === 1 ? 's' : ''} to be resolved. Choose which
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-base flex items-center gap-2">
                      ...
                      {conflict.entity_type.charAt(0).toUpperCase() +
                        conflict.entity_type.slice(1)}{' '}
                      Conflict
                    </CardTitle>
                        ...
                        >
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge variant="outline" className="text-xs">
                              ...
                              {format(
                                new Date(conflict.source_updated_at),
                                'MMM d, h:mm a'
                              )}
                            </Badge>
                          </div>
                        ...
                        >
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge variant="outline" className="text-xs">
                              <Clock className="h-3 w-3 mr-1" />
                              {format(
                                new Date(conflict.target_updated_at),
                                'MMM d, h:mm a'
                              )}
                            </Badge>
                          </div>
