    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div
              className={`text-3xl font-bold ${getScoreColor(accuracyBreakdown.overall)}`}
            >
      ...
      <Tabs defaultValue="trends" className="space-y-4">
        ...
        <TabsContent value="trends" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <AccuracyTrendChart data={historicalData} height={400} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="breakdown" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(accuracyBreakdown.byEntityType).map(
                    ([type, score]) => (
                      <div key={type}>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(accuracyBreakdown.bySeverity).map(
                    ([severity, score]) => (
                      <div key={severity}>
                        <div className="flex justify-between mb-1">
                          <span className="text-sm font-medium capitalize">
        ...
        <TabsContent value="patterns" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <AccuracyHeatmap data={historicalData} height={400} />
            </CardContent>
          </Card>
                  ...
                  <div className="flex items-start gap-2 p-3 bg-yellow-50 rounded-lg">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-yellow-700">
                        Your accuracy scores are fluctuating significantly.
                        Consider implementing more frequent sync schedules.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-2xl font-bold ${getScoreColor(benchmarkData.organizationScore)}`}
                  >
                ...
                <div className="pt-2 border-t">
                  <p className="text-sm text-muted-foreground">
                    ...
                    {benchmarkData.percentile.toFixed(0)}% of similar
                    organizations
                  </p>
                </div>
              </div>
