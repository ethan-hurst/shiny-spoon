...
describe('CSRF Protection', () => {
  ...
  describe('validateCsrfToken', () => {
    ...
    it('should validate request with multipart/form-data content type', async () => {
      headerMap.set('content-type', 'multipart/form-data; boundary=----WebKitFormBoundary')
    ...
    it('should reject cross-origin requests', async () => {
      ...
      await expect(validateCsrfToken()).rejects.toThrow('Cross-origin request not allowed')
    })
