...
test.describe('Order Management Workflow', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="orders-page"]', { timeout: 10000 })
  })
  ...
  test('should update order status', async ({ page }) => {
    ...
    // Add notes
    await page.fill('[data-testid="order-notes"]', 'Order confirmed via E2E test')
    
    // Save changes
    await page.click('[data-testid="save-order"]')
    
    // Wait for success message
    await page.waitForSelector('[data-testid="update-success"]', { timeout: 10000 })
  ...
  test('should cancel an order', async ({ page }) => {
    ...
    // Wait for success message
    await page.waitForSelector('[data-testid="cancellation-success"]', { timeout: 10000 })
  ...
  test('should add tracking event', async ({ page }) => {
    ...
    await page.fill('[data-testid="tracking-description"]', 'Package picked up by carrier')
    ...
    // Wait for success message
    await page.waitForSelector('[data-testid="tracking-success"]', { timeout: 10000 })
