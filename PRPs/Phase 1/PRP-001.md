...
CREATE truthsource directory:
  - RUN: pnpx create-next-app@latest truthsource --typescript --tailwind --app --no-src-dir --import-alias "@/*"
...
MODIFY package.json:
  - RUN: pnpm add -D @types/node prettier eslint-config-prettier husky lint-staged @ianvs/prettier-plugin-sort-imports
...
RUN: pnpx shadcn-ui@latest init
